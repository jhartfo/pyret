...
PICTUREONE  = rectangle(640, 200, "solid", "white")
#"https://code.pyret.org/shared-image-contents?sharedImageId=1xk0xZ64-7H3idwdHaJODxFijJlz7ktxo" #tatooine
PICTURETWO  = "https://code.pyret.org/shared-image-contents?sharedImageId=1ibNMJVthu0kP6n1N2PUYzaJZY7ZagKFG" #snake
PICTURETHR  = "https://code.pyret.org/shared-image-contents?sharedImageId=1yPAHqlPgKPMiqU4aK6SX9eUuwnddaooh" #ice
PICTUREFOU  = "https://code.pyret.org/shared-image-contents?sharedImageId=1-WjsH1NsEwLhgyYVGe3uGW-LATzZQpyR" #luke

# Graphics - danger, target, projectile and player images
BACKGROUND  = scale(1.00, image-url(PICTUREONE))
DANGER      = scale(0.25, image-url(PICTURETWO))
TARGET      = scale(0.25, image-url(PICTURETHR))
PLAYER      = scale(0.25, image-url(PICTUREFOU))
